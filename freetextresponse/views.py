...
class FreeTextResponseViewMixin(
    ...
    def provide_context(self, context=None):
        ...
        context.update({
            ...
            'formatted_student_answer' : self.student_answer.replace("\n", "<br>"),
